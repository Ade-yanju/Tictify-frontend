      ...
      <div className="checkout-main">
        ...
        <div className="order-summary">
          ...
          <div className="summary-item">
            ...
            <span>₦{(payment.amount * 0.02)?.toLocaleString()}</span>
          </div>
        ...
        <form onSubmit={handlePaymentSubmit} className="checkout-form">
          ...
          <div className="payment-methods">
            <label className="method-option">
              ...
              />
              <span className="method-label">💳 Debit/Credit Card (Paystack)</span>
            </label>
            <label className="method-option">
              <input
                type="radio"
              ...
              />
              <span className="method-label">📱 USSD (*737*300*...#)</span>
            </label>
            <label className="method-option">
              <input
                type="radio"
          ...
          <div className="checkout-actions">
            ...
            <p className="secure-note">🔒 PCI-DSS Compliant • SSL Encrypted</p>
          </div>
        </form>
      </div>
    </div>
